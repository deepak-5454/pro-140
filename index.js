...
function displayBot() {
    ...
    // Activity1: Replace the selector inside $() with the appropriate selector for the chatbot button
...
function askBot() {
    ...
    // Activity2: Replace the selector inside $() with the appropriate selector for the send button
    $("#send_button").click(function () {
        ...
        if (user_bot_input_text != "") {
            ...
            $.ajax({
                type: 'POST',
                // Activity3: Replace the URL with the appropriate URL for the chatbot response
                url: "/chatbot",
